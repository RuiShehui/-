 ...
 * @LastEditTime: 2022-06-10 16:55:26
 * @LastEditors: ZhangZhen
 * @Description: Zz's design
 * @FilePath: \ss-cibs-prc-inmpc\nodejs_cibs-prc-inmpc\src\api\http.js
 */
...
class HttpModel {
  ...
  _interuptor() {
    ...
    this._instance.interceptors.response.use((res) => {
      ...
      // 是否请求超时
      this.isOverTime(returnCode,returnMessage);
      // 是否请求失败
      if (returnCode !== '000000') {
        ShowMessage({
   ...
   */
  isOverTime = _.debounce(function (returnCode,returnMessage) {
