 ...
 * @LastEditTime: 2022-06-23 16:58:43
 * @LastEditors: Please set LastEditors
 * @Description: CIBS 和 T24 的对比异常表
...
<template>
  <div class="waitAuth">
    ...
    >
       <el-table-column prop="total" label="账户号码"  align="center" min-width="120"></el-table-column>
      <el-table-column prop="total" label="HOST总金额"  align="center" min-width="120"></el-table-column>
      <el-table-column prop="total" label="CIBS总金额"  align="center" min-width="120"></el-table-column>
      <el-table-column prop="total" label="差值"  align="center" min-width="120"></el-table-column>
    </el-table>
