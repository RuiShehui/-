<template>
  <div class="waitAuth">
    ...
    >
      ...
      <el-table-column prop="applyDate" label="个人网银客户号" min-width="150"></el-table-column>
      <el-table-column prop="tradeType" label="用户名" min-width="120"></el-table-column>
      <el-table-column prop="authStatus" label="邮寄地址" min-width="120"></el-table-column>
      <el-table-column prop="customerName" label="地址类型" min-width="120"></el-table-column>
      <el-table-column prop="enterpriseType" label="证件类型" min-width="120"></el-table-column>
      <el-table-column prop="cardNo" label="证件号码" min-width="120"></el-table-column>
      <el-table-column prop="address" label="证件签发地/国家" min-width="150"></el-table-column>
      <el-table-column prop="phone" label="流动电话" min-width="120"></el-table-column>
      ...
      <el-table-column prop="userStatus" label="用户状态" min-width="120"></el-table-column>
    </el-table>
