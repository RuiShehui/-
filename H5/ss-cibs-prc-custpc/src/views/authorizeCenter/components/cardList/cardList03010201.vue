 ...
 * @LastEditTime: 2022-09-24 16:32:13
 * @LastEditors: Please set LastEditors
 * @Description: 转数快
 * @FilePath: \ss-cibs-prc-custpc\src\views\authorizeCenter\components\cardList\cardList03010201.vue
-->
<template>
  ...
  methods:{
     filterType(){
      if(this.item.businessCode==='0303'){
        this.title = this.$t('AUTHORIZE.APPOINT_TRANS_MANAGE')+'-'+this.$t('PAYMENT.FAST_TRANSFER')
      }else{
        this.title = this.$t('PAYMENT.FAST_TRANSFER')
      }
    },
  }
};
