 ...
 * @LastEditTime: 2022-02-11 14:51:01
...
import forexTable from '@/views/internationalBusiness/forexListPrice/components/forexTable';
    ...
    async Datalistone(){
      ...
      for(let i = 0;i<this.tableDataone.length;i++){
        if(this.tableDataone[i].currency=='AUD'){
            ...
            console.log("数组下标：",i)
            console.log("遍历后的数据:",this.tableDataone[i].currency)
             ...
             this.tableDataone[i].currencyone = this.$t('REMITTANCECONFIRM.CNY');
